...
_G.packer_plugins = {
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  fzf = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/fzf",
    url = "https://github.com/junegunn/fzf"
  },
  ["fzf.vim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/fzf.vim",
  ...
  ["nord-vim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/nord-vim",
